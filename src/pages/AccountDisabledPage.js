...
const AccountDisabledPage = ({ onSignOut }) => (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
        <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-2xl shadow-lg text-center">
            <div>
                ...
                />
                <h1 className="text-3xl font-bold text-gray-800">Account Disabled</h1>
                <p className="mt-2 text-gray-600">Your account has been disabled. Please contact an administrator for assistance.</p>
            </div>
            <button
                onClick={onSignOut}
