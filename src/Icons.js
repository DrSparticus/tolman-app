...
export const GoogleIcon = () => (
    <svg className="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
        ...
        <path fill="#1976D2" d="M43.611 20.083l.011-.001-1.615.001H24v8h11.303c-.792 2.237-2.231 4.166-4.087 5.574l6.19 5.238C39.99 34.551 44 29.861 44 24c0-1.341-.138-2.65-.389-3.917z"/>
    </svg>
);
...
export const ChangeLogIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 3h4a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h4" />
    </svg>
);
